...
// MAJOR BUG: Newly added task only appears in the DOM after a page refresh
...
const renderTaskList = (project, task) => {
  ...
  // BUG: close button renders the inbox page even on different page
  ...
  // BUG: Not saving checkbox status across the page
...
// BUG: Renders the inbox page even on different page
